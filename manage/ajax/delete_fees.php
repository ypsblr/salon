...
// Main Code
if( isset($_SESSION['admin_id']) && isset($_REQUEST['yearmonth']) && isset($_REQUEST['fee_code']) && isset($_REQUEST['fee_group']) &&
 	isset($_REQUEST['participation_code']) && isset($_REQUEST['currency']) ) {
