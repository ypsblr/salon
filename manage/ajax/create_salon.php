...
// Main Code
if ( isset($_SESSION['admin_id']) && isset($_REQUEST['yearmonth']) && isset($_REQUEST['create-salon']) ) {
	...
	$sql .= "   registration_start_date, registration_last_date, submission_timezone, ";
	$sql .= "   submission_timezone_name, judging_start_date, judging_end_date, results_date, ";
	$sql .= "   exhibition_start_date, exhibition_end_date, ";
	$sql .= "   max_pics_per_entry, max_width, max_height, max_file_size_in_mb ";
	$sql .= " ) ";
	$sql .= " VALUES ( ";
	$sql .= " '$yearmonth', '$contest_name', '$is_salon', '$is_international', '$is_no_to_past_acceptance', ";
	$sql .= " $registration_start_date, $registration_last_date, '$submission_timezone', ";
	...
	if (! is_dir("../../salons/$yearmonth")) {
		mkdir("../../salons/$yearmonth");
		mkdir("../../salons/$yearmonth/blob");
		mkdir("../../salons/$yearmonth/img");
	}
