...
if ( isset($_SESSION['admin_id']) ) {
	...
	$salon = array(
			...
			"contest_announcement_blob" => "contest_announcement.htm",
			...
			"max_pics_per_entry" => "0", "max_width" => "1920", "max_height" => "1080", "max_file_size_in_mb" => "4", "review_in_progress" => "0",
	);
	$yearmonth = 0;
	...
	<div id="wrapper">
		<div class="normalheader transition animated fadeIn">
			<div class="hpanel">
				<div class="panel-body">
					...
					<br>
					<form role="form" method="post" id="select-salon-form" name="select-salon-form" action="salon_details.php" enctype="multipart/form-data" >
		...
		<div class="content">
			<form role="form" method="post" id="edit_contest_form" name="edit_contest_form" action="#" enctype="multipart/form-data" >
				...
				<div class="row form-group">
					<div class="col-sm-9">
						<input class="btn btn-primary pull-right" type="submit" id="edit-salon" name="edit-salon" value="Update">
					</div>
				</div>
			</form>
		</div>
	...
	$(document).ready(function(){
		let vaidator = $('#edit_contest_form').validate({
			...
			submitHandler: function(form) {
				...
				$('#loader_img').show();
				$.ajax({
						url: "ajax/update_salon_details.php",
						type: "POST",
						data: formData,
						cache: false,
						processData: false,
