...
class Certificate {
	// Constants
	// Text Colors
	const COLOR_LABEL = 0x0;
	const COLOR_FIELD = 0xf34508;
	const COLOR_SUBDUED = 0x808080;
	const COLOR_HIGHLIGHT = 0xf34508;
	...
	// Fonts
	const FONT_FAMILY = "Libel Suit";
	const FONT_REGULAR = "libel-suit-rg.ttf";
	const FONT_BOLD = "libel-suit-rg.ttf";
	const FONT_ITALIC = "libel-suit-rg.ttf";


	// Other Constants
	const FILE_NAME_STUB = "YPS-ALL-INDIA-SALON-2017";

	// Protected
	protected $templates = array ("1" => "35AIS Certificate.jpg", "2" => "35AIS Certificate.jpg", "3" => "35AIS Certificate.jpg",
									"4" => "35AIS Certificate.jpg", "5" => "35AIS Certificate.jpg", "9" => "35AIS Certificate.jpg",
									"99" => "35AIS Certificate.jpg");
	protected $templates_cm = array ("1" => "35AIS Certificate.jpg", "2" => "35AIS Certificate.jpg", "3" => "35AIS Certificate.jpg",
									"4" => "35AIS Certificate.jpg", "5" => "35AIS Certificate.jpg", "9" => "35AIS Certificate.jpg",
									"99" => "35AIS Certificate.jpg");

	protected $blocks = array (
							"thumbnail_block" => array("type" => "tile", "x" => 8, "y" => 140, "width" => 60, "height" => 60, "fill_color" => "", "border_width" => "0", "border_color" => "", ),
							"award_block" => array("type" => "canvas", "x" => 106, "y" => 90, "width" => 180, "height" => 96, "fill_color" => "", "border_width" => "0", "border_color" => "", )
							);
	...
	protected $nodes = array (
						...
						"author_name" => array("nodetype" => "text", "type" => "field", "posx" => 0, "posy" => 0,
										"font_family" => self::FONT_FAMILY, "font_style" => "", "font_size" => 28, "font_color" => self::COLOR_FIELD,
									    "align" => "R", "line_spacing" => 1.2, "height" => 0, "group" => "name", "block" => "award_block", "sequence" => 1),

						"honors" => array("nodetype" => "text", "type" => "field", "posx" => 0, "posy" => 10,
										"font_family" => self::FONT_FAMILY, "font_style" => "", "font_size" => 10, "font_color" => self::COLOR_SUBDUED,
									    "align" => "R", "line_spacing" => 1.1, "height" => 0, "group" => "name", "block" => "award_block", "sequence" => 2),
						...
						// 			    	"align" => "L", "line_spacing" => 1, "height" => 10, "group" => "award", "block" => "award_block", "sequence" => 4),
						...
						"award_name" => array("nodetype" => "text", "type" => "field", "posx" => 0, "posy" => 24,
										  "font_family" => self::FONT_FAMILY, "font_style" => "", "font_size" => 20, "font_color" => self::COLOR_FIELD,
									    "align" => "R", "line_spacing" => 1.1, "height" => 0, "group" => "award", "block" => "award_block", "sequence" => 6),

						// "blank_line_2" => array("nodetype" => "text", "type" => "label", "value" => "",
						// 				  	"font_family" => self::FONT_FAMILY, "font_style" => "", "font_size" => 8, "font_color" => self::COLOR_LABEL,
						// 			    	"align" => "L", "line_spacing" => 1, "height" => 10, "group" => "award", "block" => "award_block", "sequence" => 7),
						...
						"title" => array("nodetype" => "text", "type" => "field", "posx" => 0, "posy" => 48,
										  "font_family" => self::FONT_FAMILY, "font_style" => "", "font_size" => 20, "font_color" => self::COLOR_FIELD,
									    "align" => "R", "line_spacing" => 1.1, "height" => 0, "group" => "title", "block" => "award_block", "sequence" => 9),
