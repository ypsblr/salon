...
class ImageMerge {
	...
	const FILE_NAME_STUB = "IS2021-RIBBON-HOLDER";
	const BASE_IMAGE = "is2021_ribbon_holder.png";
	const RIBBON_AWARD = 9;
	// const AWARD_ID_LIST = "'501', '502', '503', '504'";
	...
	protected $fields = [
							// Print Size 2400 x 2700 Design
							array ("type" => "text", "field" => "award_name", "value" => "",
									"font" => self::FONT_BOLD, "font_size" => 80, "font_color" => self::COLOR_THEME,
									"x" => 225, "y" => 675, "width" => 1000, "height" => 100, "rotate" => 0, "position" => "MM",
							...
							array ("type" => "text", "field" => "label", "value" => "awarded to",
									...
									"x" => 225, "y" => 775, "width" => 1000, "height" => 100, "rotate" => 0, "position" => "MM",
									"fill_color" => "", "border_size" => 0, "border_color" => ""),
							...
							array ("type" => "text", "field" => "section", "value" => "",
									...
									"x" => 48, "y" => 2260, "width" => 1350, "height" => 120, "rotate" => 0, "position" => "MM",
									"fill_color" => self::COLOR_THEME, "border_size" => 0, "border_color" => ""),
							array ("type" => "image", "field" => "picfile", "value" => "",
									"x" => 325, "y" => 1250, "width" => 800, "height" => 800, "rotate" => 0, "position" => "MM",
									"fill_color" => "", "border_size" => 2, "border_color" => self::COLOR_GOLD, "border_gap" => 2),
							// A4 Size Design
							// array ("type" => "text", "field" => "award_name", "value" => "",
							// 		"font" => self::FONT_BOLD, "font_size" => 80, "font_color" => self::COLOR_THEME,
							// 		"x" => 580, "y" => 675, "width" => 1000, "height" => 100, "rotate" => 0, "position" => "MM",
							// 		"fill_color" => "", "border_size" => 0, "border_color" => ""),
							// array ("type" => "text", "field" => "label", "value" => "awarded to",
							// 		"font" => self::FONT_BOLD, "font_size" => 64, "font_color" => self::COLOR_SUBDUED,
							// 		"x" => 580, "y" => 775, "width" => 1000, "height" => 100, "rotate" => 0, "position" => "MM",
							// 		"fill_color" => "", "border_size" => 0, "border_color" => ""),
							// array ("type" => "text", "field" => "profile_name", "value" => "",
							// 		"font" => self::FONT_BOLD, "font_size" => 64, "font_color" => self::COLOR_FIELD,
							// 		"x" => 580, "y" => 1000, "width" => 1000, "height" => 80, "rotate" => 0, "position" => "MM",
							// 		"fill_color" => "", "border_size" => 0, "border_color" => ""),
							// array ("type" => "text", "field" => "honors", "value" => "",
							// 		"font" => self::FONT_BOLD, "font_size" => 32, "font_color" => self::COLOR_SUBDUED,
							// 		"x" => 580, "y" => 1100, "width" => 1000, "height" => 50, "rotate" => 0, "position" => "MM",
							// 		"fill_color" => "", "border_size" => 0, "border_color" => ""),
							// array ("type" => "text", "field" => "title", "value" => "",
							// 		"font" => self::FONT_BOLD, "font_size" => 64, "font_color" => self::COLOR_FIELD,
							// 		"x" => 580, "y" => 2080, "width" => 1000, "height" => 80, "rotate" => 0, "position" => "MM",
							// 		"fill_color" => "", "border_size" => 0, "border_color" => self::COLOR_GOLD, "border_gap" => 0),
							// array ("type" => "text", "field" => "section", "value" => "",
							// 		"font" => self::FONT_BOLD, "font_size" => 64, "font_color" => self::COLOR_WHITE,
							// 		"x" => 405, "y" => 2260, "width" => 1350, "height" => 120, "rotate" => 0, "position" => "MM",
							// 		"fill_color" => self::COLOR_THEME, "border_size" => 0, "border_color" => ""),
							// array ("type" => "image", "field" => "picfile", "value" => "",
							// 		"x" => 680, "y" => 1250, "width" => 800, "height" => 800, "rotate" => 0, "position" => "MM",
							// 		"fill_color" => "", "border_size" => 2, "border_color" => self::COLOR_GOLD, "border_gap" => 2),
						];
	...
	function getMergeData() {
		...
		if ($row = mysqli_fetch_array($this->query)) {
			$this->target_folder = $_SERVER['DOCUMENT_ROOT'] . "/generated/" . self::YEARMONTH . "/ribbon_holders/" . $row['section'];
			$this->save_file_name = self::FILE_NAME_STUB . "-" . $row['recognition_code'] . "-" . $row['profile_id'] . "-" . $row['pic_id'] . $this->save_file_type;
			foreach ($this->fields as $field => $config) {
				if (isset($row[$config['field']])) {
					...
					// 	$this->fields[$field]["value"] = honors_text($row['picfile']);
					elseif (isset($config["function"]) && $config["function"] != "") {
						$function = $config["function"];
						$this->fields[$field]["value"] = $function($row[$config['field']]);
					}
					else
