...
**
** Certificate Definition for All India Digital Salon 2019
*/
class Certificate {
	// Constants
	// Text Colors
	const COLOR_LABEL = 0xB09400;
	const COLOR_FIELD = 0x2B601C;
	...
	const FONT_REGULAR = "DejaVuSerif.ttf";
	const FONT_BOLD = "DejaVuSerif-Bold.ttf";
	const FONT_ITALIC = "DejaVuSerif-Italic.ttf";

	// Other Constants
	const FILE_NAME_STUB = "YPS-ALL-INDIA-SALON-2019";

	// Protected
	protected $templates = array ("1" => "YPS_AIS_2019_CERTIFICATE.jpg", "2" => "YPS_AIS_2019_CERTIFICATE.jpg", "3" => "YPS_AIS_2019_CERTIFICATE.jpg",
									"4" => "YPS_AIS_2019_CERTIFICATE.jpg", "5" => "YPS_AIS_2019_CERTIFICATE.jpg", "9" => "YPS_AIS_2019_CERTIFICATE.jpg",
									"99" => "YPS_AIS_2019_CERTIFICATE.jpg");
	protected $templates_cm = array ("1" => "YPS_AIS_2019_CERTIFICATE.jpg", "2" => "YPS_AIS_2019_CERTIFICATE.jpg", "3" => "YPS_AIS_2019_CERTIFICATE.jpg",
									"4" => "YPS_AIS_2019_CERTIFICATE.jpg", "5" => "YPS_AIS_2019_CERTIFICATE.jpg", "9" => "YPS_AIS_2019_CERTIFICATE.jpg",
									"99" => "YPS_AIS_2019_CERTIFICATE.jpg");

	protected $blocks = array (
							"thumbnail_block" => array("type" => "tile", "x" => 20, "y" => 240, "width" => 120, "height" => 120, "fill_color" => "", "border_width" => "0", "border_color" => "", ),
							"award_block" => array("type" => "list", "x" => 240, "y" => 185, "width" => 390, "height" => 125, "fill_color" => "", "border_width" => "0", "border_color" => "", ),
							"sponsor_logo_block" => array("type" => "tile", "x" => 120, "y" => 374, "width" => 100, "height" => 52, "fill_color" => "", "border_width" => "0", "border_color" => ""),
							"sponsor_block" => array("type" => "list", "x" => 220, "y" => 374, "width" => 218, "height" => 52, "fill_color" => "", "border_width" => "0.5", "border_color" => 0x808080)
							);
	...
	protected $nodes = array (
						...
						"blank_line_1" => array("nodetype" => "text", "type" => "label", "value" => "",
									    	...
									    	"align" => "L", "line_spacing" => 1, "height" => 0, "group" => "award", "block" => "award_block", "sequence" => 4),
						...
						"blank_line_2" => array("nodetype" => "text", "type" => "label", "value" => "",
										  	"font_family" => self::FONT_FAMILY, "font_style" => "", "font_size" => 8, "font_color" => self::COLOR_LABEL,
									    	"align" => "L", "line_spacing" => 1, "height" => 0, "group" => "award", "block" => "award_block", "sequence" => 7),
						...
						"picfile" => array("nodetype" => "image", "type" => "field",
											 "align" => "center", "bordertype" => "border", "borderwidth" => 1, "bordercolor" => self::COLOR_SUBDUED,
