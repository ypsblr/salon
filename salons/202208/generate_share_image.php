...
$poster->createProfileArea (15, 800, 800, 120, $name_font, $honors_font);
...
if ($si_acceptances > 0) {
    ...
    $poster->createThumbnailArea(15, 15, 1050, 780, $gap_size);
    ...
    // Award area
	$pic_award_font = array("size" => 48, "color" => "FFFFFF", "font" => "PetitaBold.ttf");
    $spl_award_font = array("size" => 48, "color" => "000000", "font" => "PetitaBold.ttf");
    $poster->createAwardArea(15, 415, 1000, 200, $pic_award_font, $spl_award_font);
