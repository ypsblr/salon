...
class Certificate {
	...
	const FONT_REGULAR = "Oswald-Regular.ttf";
	const FONT_BOLD = "Oswald-SemiBold.ttf";
	const FONT_ITALIC = "Oswald-Light.ttf";

	// Other Constants
	const FILE_NAME_STUB = "YPS-INTLSALON2020";

	// Protected
	protected $templates = array ("1" => "YPSIS2019CERT.jpg", "2" => "YPSIS2019CERT.jpg", "3" => "YPSIS2019CERT.jpg",
									"4" => "YPSIS2019CERT.jpg", "5" => "YPSIS2019CERT.jpg", "9" => "YPSIS2019CERT.jpg",
									"99" => "YPSIS2019CERT.jpg");
	protected $templates_cm = array ("1" => "YPSIS2019CERT.jpg", "2" => "YPSIS2019CERT.jpg", "3" => "YPSIS2019CERT.jpg",
									"4" => "YPSIS2019CERT.jpg", "5" => "YPSIS2019CERT.jpg", "9" => "YPSIS2019CERT.jpg",
									"99" => "YPSIS2019CERT.jpg");

	protected $blocks = array (
							"thumbnail_block" => array("type" => "tile", "x" => 20, "y" => 240, "width" => 120, "height" => 120, "fill_color" => "", "border_width" => "0", "boder_color" => "", ),
							"award_block" => array("type" => "list", "x" => 220, "y" => 215, "width" => 390, "height" => 120, "fill_color" => "", "border_width" => "0", "boder_color" => "", )
							);
	...
	protected $nodes = array (
						...
						"label_2" => array("nodetype" => "text", "type" => "label", "value" => "for the picture",
										  	"font_family" => self::FONT_FAMILY, "font_style" => "", "font_size" => 14, "font_color" => self::COLOR_LABEL,
