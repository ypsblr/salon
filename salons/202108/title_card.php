...
class ImageMerge {
	...
	const FILE_NAME_STUB = "AIS2021-TITLE-CARD";
	const BASE_IMAGE = "ais2021_titlecard.png";		// 1800w x 1200h - 6x3 inch card
	...
	protected $fields = [
							...
							array ("type" => "image", "field" => "avatar", "value" => "", "grow" => 2,
									"x" => 1165, "y" => 425, "width" => 350, "height" => 350, "rotate" => 0, "position" => "MM",
									"fill_color" => "", "border_size" => 0, "border_color" => "", "border_gap" => 0),
							...
							array ("type" => "text", "field" => "profile_name", "value" => "",
									...
									"x" => 360, "y" => 410, "width" => 740, "height" => 80, "rotate" => 0, "position" => "MT",
							...
							array ("type" => "text", "field" => "honors", "value" => "",
									...
									"x" => 360, "y" => 510, "width" => 740, "height" => 40, "rotate" => 0, "position" => "MT",
									"fill_color" => "", "border_size" => 0, "border_color" => ""),
							// Award Name
							array ("type" => "text", "field" => "award_name", "value" => "",
									"font" => self::FONT_BOLD, "font_size" => 48, "font_color" => self::COLOR_GOLD,
									"x" => 360, "y" => 610, "width" => 740, "height" => 60, "rotate" => 0, "position" => "MB",
									"fill_color" => "", "border_size" => 0, "border_color" => ""),
							// Picture Title
							array ("type" => "text", "field" => "title", "value" => "",
									"font" => self::FONT_BOLD, "font_size" => 64, "font_color" => self::COLOR_FIELD,
									"x" => 360, "y" => 710, "width" => 740, "height" => 80, "rotate" => 0, "position" => "MB",
							...
							array ("type" => "text", "field" => "section", "value" => "",
									...
									"x" => 360, "y" => 990, "width" => 740, "height" => 100, "rotate" => 0, "position" => "MB",
									"fill_color" => "", "border_size" => 0, "border_color" => ""),
						];
