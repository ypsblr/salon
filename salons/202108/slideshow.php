...
class ImageMerge {
	...
	const FILE_NAME_STUB = "AIS2021-SS";
	const BASE_IMAGE = "ais2021_slideshow.png";
	...
	protected $fields = [
							...
							array ("type" => "text", "field" => "city", "value" => "",
									...
									"x" => 20, "y" => 1010, "width" => 280, "height" => 20, "rotate" => 0, "position" => "LT",
									"fill_color" => "", "border_size" => 0, "border_color" => ""),
							// Honors
							array ("type" => "text", "field" => "honors", "value" => "",
									"font" => self::FONT_ITALIC, "font_size" => 12, "font_color" => self::COLOR_SUBDUED,
									"x" => 20, "y" => 1040, "width" => 280, "height" => 20, "rotate" => 0, "position" => "LT",
									"fill_color" => "", "border_size" => 0, "border_color" => ""),
							// Pic Title
							...
							array ("type" => "text", "field" => "section", "value" => "",
									...
									"x" => 22, "y" => 200, "width" => 80, "height" => 500, "rotate" => 90, "position" => "LT",
									"fill_color" => "", "border_size" => 0, "border_color" => ""),
							// exif - iso
	...
	function __construct($dbcon, $param) {
		...
		$this->sql  = "SELECT profile.profile_id, profile.profile_name, country.country_name, honors, avatar, city, state, ";
		$this->sql .= "       title, pic.pic_id, pic.section, picfile, award.award_name, award.level, award.sequence ";
