...
class Certificate {
	...
	// Fonts
	const FONT_FAMILY = "Ogirema";
	const FONT_REGULAR = "Ogirema.ttf";
	const FONT_BOLD = "OgiremaBold.ttf";
	const FONT_ITALIC = "OgiremaItalic.ttf";
	...
	// Other Constants
	const FILE_NAME_STUB = "YPS-INTERNATIONAL-SALON-2018";

	// Protected
	protected $templates = array ("1" => "YPS_IS_2018_CERTIFICATE.jpg", "2" => "YPS_IS_2018_CERTIFICATE.jpg", "3" => "YPS_IS_2018_CERTIFICATE.jpg",
									"4" => "YPS_IS_2018_CERTIFICATE.jpg", "5" => "YPS_IS_2018_CERTIFICATE.jpg", "9" => "YPS_IS_2018_CERTIFICATE.jpg",
									"99" => "YPS_IS_2018_CERTIFICATE.jpg");
	protected $templates_cm = array ("1" => "YPS_IS_2018_CERTIFICATE.jpg", "2" => "YPS_IS_2018_CERTIFICATE.jpg", "3" => "YPS_IS_2018_CERTIFICATE.jpg",
									"4" => "YPS_IS_2018_CERTIFICATE.jpg", "5" => "YPS_IS_2018_CERTIFICATE.jpg", "9" => "YPS_IS_2018_CERTIFICATE.jpg",
									"99" => "YPS_IS_2018_CERTIFICATE.jpg");

	protected $blocks = array (
							"thumbnail_block" => array("type" => "tile", "x" => 210, "y" => 70, "width" => 70, "height" => 70, "fill_color" => "", "border_width" => "0", "border_color" => "", ),
							"award_block" => array("type" => "canvas", "x" => 11, "y" => 74, "width" => 180, "height" => 96, "fill_color" => "", "border_width" => "0", "border_color" => "", )
							);
	...
	protected $nodes = array (
						...
						"honors" => array("nodetype" => "text", "type" => "field", "posx" => 0, "posy" => 12,
						...
						// 			    	"align" => "L", "line_spacing" => 1, "height" => 17, "group" => "award", "block" => "award_block", "sequence" => 4),
						...
						"award_name" => array("nodetype" => "text", "type" => "field", "posx" => 0, "posy" => 29,
						...
						// 				  	"font_family" => self::FONT_FAMILY, "font_style" => "", "font_size" => 8, "font_color" => self::COLOR_LABEL,
						// 			    	"align" => "L", "line_spacing" => 1, "height" => 21, "group" => "award", "block" => "award_block", "sequence" => 7),
						...
						"title" => array("nodetype" => "text", "type" => "field", "posx" => 0, "posy" => 62,
										  "font_family" => self::FONT_FAMILY, "font_style" => "B", "font_size" => 24, "font_color" => self::COLOR_FIELD,
