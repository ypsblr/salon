...
// $catalog_list = array(
// 					array("year" => 2021, "salon_name" => "YPS International Digital Salon 2021", "patronage" => "FIAP 2021/533, FIP 2021/FIP/197/2021, GPU L210169, ICS 2021/132, MoL 2021/88, PSA 2021-1608, YPS 2021/001",
// 						  "chairman" => "Satish Hanumantharao", "secretary" => "Manju Vikas Sastry V",
// 						  "jury" => "David Poey Cher Tay, Mohammad Ali Salim, Nils-Erik Jerelmar, Anil Risal Singh, Madhu Sarkar, Ioannis Lykouris, Gunther Riehle, Riccardo Busi, Roy Killen, Luis Alberto Franke, Sanjoy Sengupta, Agatha Anne Bunanta",
// 						  "exhibition_venue" => "Chitrakala Parishath", "exhibition_from" => "2022-02-25", "exhibition_to" => "2022-02-27",
// 						  "img" => "YPS_2021_IS_012.jpg", "catalog" => "YPS_2021_IS_012.pdf", "download" => "YPS_2021_IS_012_D.pdf"),
//
		...
		<div class="container-fluid intro">
			<div class="row">
				...
				<div class="col-sm-8 col-md-8 col-lg-8" style="padding-left:3%">
					...
					<?php
						$index = 0;
						$sql = "SELECT * FROM catalog ORDER BY yearmonth DESC ";
						$query = mysqli_query($DBCON, $sql) or sql_error($sql, mysqli_error($DBCON), __FILE__, __LINE__);
						// foreach ($catalog_list as $catalog) {
						while ($catalog = mysqli_fetch_array($query, MYSQLI_ASSOC)) {
							$cover_page = "catalog/img/" . $catalog['catalog_img'];
							$tool_tip = "";
					...
					?>
						<div class="col-sm-3 thumbnail">
							...
							<div style="max-width:100%;" >
								<a href="viewer/viewer.html?file=/catalog/<?= $catalog['catalog_view'];?>#magazineMode=true" target="_blank" >
									<img class="img-responsive" style="margin-left:auto; margin-right:auto;" src="/catalog/img/<?= $catalog['catalog_img'];?>" >
								</a>
							</div>
							<div class="caption">
							...
							<div><a class="btn btn-color" style="width: 100%;" href="catalog/<?= $catalog['catalog_download']; ?>" download >Download</a></div>
						</div>
					<?php
							++ $index;
							if ($index % 4 == 0) {
