...
(function (PhotoHistogram) {
    ...
    var Ui = (function () {
        function Ui(parent, source, options) {
            ...
            this.parent = parent;
			// Added by Murali to render Histogram without Controls
			if (options.controls && options.controls == 'none')
				this.controls = false;
			else
				this.controls = true;
        ...
        Ui.prototype.selectedChannel = function () {
			// Modified by Murali to render histogram without controls - Renders Colors Channel
            return (this.controls) ? parseInt(document.getElementById(this.id.selectChannels).value, 10) : 0;
        };
