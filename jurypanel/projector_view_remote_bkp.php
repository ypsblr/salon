						...
						?>
							...
							>
								...
								<div class="pull-right" style="display: inline-block;">
									...
									<!-- Show other sections -->
									<a class="show-other-sections" style="padding-right: 10px;" data-toggke="tooltip" title="Uploads in other sections">
										<i class="glyphicon glyphicon-random small"></i>
									</a>
									<!-- Show History -->
									<a class="show-history" style="padding-right: 10px;" data-toggke="tooltip" title="Accepted in past salons">
		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h5 class="modal-title" id="image-review-header-label"><span id="compared-with-what"></span></h4>
				</div>
				<div class="modal-body">
					<div class="row">
						<div class="col-sm-6">
...
function show_other_sections(profile_id, picfile) {
	// Save location
	...
	$.post("ajax/get_other_sections.php", {yearmonth, profile_id, section, columns}, function(data) {
		$("#modal-compared-images").html(data);
	});

	// Show Modal
	$("#compared-with-what").html("Uploaded under other Sections");
...
$(document).ready(function(){
	...
	$(".show-other-sections").click(function(){
		let profile_id = $(this).parents(".salon-pic").attr("data-profile-id");
		let picfile = $(this).parents(".salon-pic").find("a.picfile").attr("href");
		show_other_sections(profile_id, picfile);
	});
});
